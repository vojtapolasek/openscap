...
function test_offline_mode_symlink_2 {
    ...
    bash ${srcdir}/test_offline_mode_symlink_2.xml.sh "" > "$DF"
...
test_init "test_offline_mode_symlink_2.log"

test_run "test_offline_mode_symlink_2" test_offline_mode_symlink_2
